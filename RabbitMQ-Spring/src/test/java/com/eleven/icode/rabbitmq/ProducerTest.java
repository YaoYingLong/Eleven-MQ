...
public class ProducerTest {
    ...
    @Test
    public void testQos() {  // 批量发送消息，让消费者每次拉去指定的数量
    ...
    public void testTtl() {
        for (int i = 0; i < 10; i++) { // 发送消息
            rabbitTemplate.convertAndSend("test_exchange_ttl", "ttl.eleven", "message ttl....");
        }
    }
    ...
    public void testDlx() {
       ...
       /* for (int i = 0; i < 20; i++) {
        ...
        //3. 测试消息拒收
        // rabbitTemplate.convertAndSend("test_exchange_dlx","test.dlx.eleven","死信消息测试3，开始...");
    }
